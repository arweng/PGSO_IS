...
<html>
    ...
    <body class="fixed-left" ng-app="reports" ng-controller="reportCtrl" account-profile>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub" ng-show="accountProfile.pages_access.report.value">
                                ...
                                <ul class="list-unstyled">
                                    <li class="active"><a href="PAR_report.php">Property Acknowledgement Receipt</a></li>
                            ...
                            <li class="has_sub" ng-show="accountProfile.pages_access.maintemance.value">
        ...
        <script src="modules/par_reports.js"></script>
        <script src="controllers/par_reports.js"></script>
