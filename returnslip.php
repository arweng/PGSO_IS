...
<html>
    ...
    <body class="fixed-left" ng-app="returnslip" ng-controller="returnslipCtrl" account-profile>
 ...
 -->
                        ...
                        <ul>
                            ...
                            <li class="has_sub" ng-show="accountProfile.pages_access.equipment.value">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="active"><a href="returnslip.php">Return Slip</a></li>
        ...
        <script src="modules/returnslip.js"></script>
        <script src="controllers/returnslip.js"></script>
