...
<html>
    ...
    <body class="fixed-left" ng-app="unit" ng-controller="unitCtrl" account-profile>
                        ...
                        <ul>
                            ...
                            <li class="has_sub" ng-show="accountProfile.pages_access.maintenance.value">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="active"><a href="units.php">Units</a></li>
        ...
        <script src="modules/unit.js"></script>
        <script src="controllers/unit.js"></script>
