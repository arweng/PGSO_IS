...
<html>
    ...
    <body class="fixed-left" ng-app="type" ng-controller="typeCtrl" account-profile>
                        ...
                        <ul>
                            ...
                            <li class="has_sub" ng-show="accountProfile.pages_access.maintenance.value">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="active"><a href="type.php">Type</a></li>
        ...
        <script src="modules/type.js"></script>
