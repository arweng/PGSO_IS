	...
	self.save = function(scope) {
		...
		data: {department: scope.department}
			...
			if (scope.department.id == 0) {
				...
				growl.show('btn btn-success',{from: 'top', amount: 55},'Department Information successfully added.');
				}	else{
					growl.show('btn btn-success',{from: 'top', amount: 55},'Department Information successfully updated.');
				}
