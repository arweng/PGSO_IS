                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub" ng-show="accountProfile.pages_access.report.value">
                                <a href="#" class="waves-effect active"><i class="ti-write"></i>Equipment<span class="label label-success pull-right">5</span></a>
                                <ul class="list-unstyled">
                                    <li class="active"><a href="fill_equipment.php">Fill in Equipment</a></li>
